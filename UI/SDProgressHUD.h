...
typedef void (^SDProgressHUDCompletionBlock)(void);
#endif
 ...
 * animations while disappearing.
 * @return the nuSDUIer of HUDs found and removed.
 *
 * @see hideHUDForView:animated:
 * @see animationType
 */
 ...
 */
@property (weak) id<SDProgressHUDDelegate> delegate;
 ...
 */
@interface SDUIRoundProgressView : UIView
 ...
 */
@interface SDUIBarProgressView : UIView
